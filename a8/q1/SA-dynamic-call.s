...
foo:             deca r5                  # allocate space for frame
                 ...
                 deca r5
                 st   r0, (r5)
                 ld   0x4(r1), r1         # load a->class->ping
                 gpc  $0x2, r6            # ra = pc + 2
                 ...
                 deca r5
                 st   r0, (r5)
                 ld   0x8(r1), r1         # load a->class->pong
                 gpc  $0x2, r6            # ra = pc + 2
                 j    (r1)                # a->class->pong (this)
                 inca r5
...
C_ping:          deca r5                  
                 ...
                 deca r5                  
                 st   r0, 0x0(r5)         
                 ld   0x4(r1), r1         # load this->class->super->ping (this)
                 gpc  $0x2, r6            
                 j    (r1)                # pc = this->class->super->ping (this)
                 inca r5                  
                 ld   0x0(r5), r6         
                 inca r5                  
                 j    0x0(r6)             
